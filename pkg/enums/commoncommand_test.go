...
func TestParseCommonCommandFromByte(t *testing.T) {
	t.Run("parses all valid common commands correctly", func(t *testing.T) {
		testCases := []struct {
			...
			{0x34, CommonCommandSET_CRCMode},
			{0x35, CommonCommandGET_CRCMode},
			...
			{0x3c, CommonCommandWR_SECUREDEVICE_REMAN_KEY},
			{0x3d, CommonCommandRD_SECUREDEVICE_REMAN_KEY},
	...
	t.Run("returns error for invalid common command", func(t *testing.T) {
		invalidInputs := []byte{0x00, 0x26, 0x28, 0x29, 0x2a, 0x2b, 0x2c, 0x2d, 0x42, 0xff}
...
func TestCommonCommand_String(t *testing.T) {
	t.Run("returns correct string for all valid common commands", func(t *testing.T) {
		testCases := []struct {
			...
			{CommonCommandSET_CRCMode, "SET_CRCMode"},
			{CommonCommandGET_CRCMode, "GET_CRCMode"},
			...
			{CommonCommandWR_SECUREDEVICE_REMAN_KEY, "WR_SECUREDEVICE_REMAN_KEY"},
			{CommonCommandRD_SECUREDEVICE_REMAN_KEY, "RD_SECUREDEVICE_REMAN_KEY"},
	...
	t.Run("returns UNKNOWN for invalid common commands", func(t *testing.T) {
		invalidTypes := []CommonCommand{0x00, 0x26, 0x28, 0x29, 0x2a, 0x2b, 0x2c, 0x2d, 0x42, 0xff}
